...
- Built on top of
  ...
  for enhanced accessibility and reliability.
- The label prop links an accessible label to the checkbox.
- If an id is not explicitly provided, a unique ID is automatically generated to
  associate the checkbox and its label.
